...
export const SOURCE_TO_TARGET = 'SOURCE_TO_TARGET';
export const CHANGE_HANDLE_STYLE = 'CHANGE_HANDLE_STYLE';
...
export const SET_SOURCE_USING_EDGE = 'SET_SOURCE_USING_EDGE';
